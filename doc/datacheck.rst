...
.. class:: BoolCheck(name [, none_is_false])

    The optional attribute on top of the standard attributes:

    .. attribute:: none_is_false [default True]

        If True, accepts `None` or "None" and treates as **False**.

:class:`BoolCheck` accepts the following values and normalizes them as **True**

    * ``True``, "TRUE", "True", "true", "T", "t", "YES", "Yes", "yes", "Y", "y", "1"

:class:`BoolCheck` accepts the following values and normalizes them as **False**
